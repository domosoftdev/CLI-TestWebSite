...
KEYWORDS_FOR_SALE = [
    ...
    "domain available", "domaine disponible", "purchase this domain",
    "acquire this domain", "this domain is for sale", "ce domaine est à vendre",
    "buy now", "acheter maintenant", "make an offer", "faire une offre",
    "for sale by owner", "vente par le propriétaire", "domain auction",
    "buy it now", "achat immédiat", "domain broker", "courtier domaine",

    # Variations en plusieurs langues
    "zu verkaufen", "te koop", "in vendita", "para la venta", "på salg",
    "for salg", "myydään", "sprzedaż", "продается", "出售",

    # Phrases commerciales
    "inquire now", "contact owner", "contactez propriétaire", "renseignements",
    "price negotiable", "prix négociable", "best offer", "meilleure offre",
    "premium domain", "domaine premium", "valuable domain", "domaine de valeur",
    "investment opportunity", "opportunité d'investissement",
    "brandable domain", "domaine brandable", "exact match domain",

    # Services de vente de domaines
    "sedo", "afternic", "flippa", "dan.com", "undeveloped.com",
    "hugedomains", "godaddy auctions", "namecheap marketplace",
    "domain name sales", "vente nom de domaine",

    # Actions d'achat
    "click here to buy", "cliquez ici pour acheter", "purchase instantly",
    "instant buy", "achat instantané", "add to cart", "ajouter au panier",
    "checkout", "secure payment", "paiement sécurisé"
]
...
KEYWORDS_PARKING_GENERIC = [
    ...
    "this domain is parked", "ce domaine est parqué",
    "domain name parking", "stationnement de nom de domaine",

    # États temporaires
    "under construction", "en construction", "coming soon", "bientôt disponible",
    "site under development", "site en développement", "website coming soon",
    "page temporarily unavailable", "page temporairement indisponible",
    "future home of", "futur domicile de", "placeholder page",
    "temporary page", "page temporaire", "work in progress",

    # Services de parking populaires
    "bodis", "parkingcrew", "above.com", "domcollect", "nameservers.com",
    "sedoparking", "parking page", "default page", "page par défaut",
    "registrar default page", "page par défaut du registraire",
    "web hosting default page", "page par défaut hébergement",

    # Publicités et revenus
    "sponsored links", "liens sponsorisés", "related searches",
    "recherches associées", "advertising", "publicité", "ads by",
    "publicités par", "revenue", "revenus", "monetization",
    "click here for", "cliquez ici pour", "search results",
    "résultats de recherche", "pay per click", "paiement par clic",

    # Messages de redirection
    "redirect", "redirection", "forwarding", "transfert",
    "this page will redirect", "cette page va rediriger",
    "automatic redirect", "redirection automatique",

    # États d'erreur ou vides
    "default web site page", "page web par défaut", "test page",
    "page de test", "it works", "ça marche", "apache default",
    "nginx default", "iis default", "server default page",
    "welcome to", "bienvenue à", "congratulations", "félicitations"
]

KEYWORDS_PLACEHOLDER_CONTENT = [
    # Contenu minimal typique
    "lorem ipsum", "placeholder text", "texte de remplacement",
    "sample text", "exemple de texte", "dummy text", "faux texte",
    "test content", "contenu de test", "default content",
    "contenu par défaut", "template", "modèle",

    # Messages génériques
    "this is the default page", "ceci est la page par défaut",
    "no website configured", "aucun site web configuré",
    "account suspended", "compte suspendu", "service unavailable",
    "service indisponible", "bandwidth exceeded", "bande passante dépassée",

    # États techniques
    "404 not found", "page not found", "page non trouvée",
    "503 service unavailable", "500 internal error",
    "maintenance mode", "mode maintenance", "offline",
    "hors ligne", "temporarily down", "temporairement arrêté"
]

KEYWORDS_SEARCH_RELATED = [
    # Termes de recherche
    "search", "recherche", "find", "trouver", "discover", "découvrir",
    "explore", "explorer", "browse", "naviguer", "directory", "annuaire",
    "categories", "catégories", "topics", "sujets", "keywords", "mots-clés",

    # Suggestions automatiques
    "related to", "lié à", "similar to", "similaire à", "you might like",
    "vous pourriez aimer", "recommended", "recommandé", "suggested",
    "suggéré", "popular searches", "recherches populaires",
    "trending", "tendance", "most searched", "plus recherché"
]

KEYWORDS_CONTACT_FORMS = [
    # Formulaires de contact basiques
    "contact us", "contactez-nous", "get in touch", "prenez contact",
    "send message", "envoyer message", "inquiry", "demande",
    "contact form", "formulaire de contact", "email us", "envoyez-nous",
    "your name", "votre nom", "your email", "votre email",
...
PARKING_SERVICES = [
    # Principaux services
    "sedo.com", "parkingcrew.net", "bodis.com", "above.com",
    "domcollect.com", "afternic.com", "dan.com", "undeveloped.com",
    "hugedomains.com", "domainnameshop.com", "nameservers.com",

    # Services affiliés
    "google.com/adsense", "googlesyndication.com", "doubleclick.net",
    "adsystem.com", "advertising.com", "yahoo.com", "bing.com",

    # Registraires avec parking intégré
    "godaddy.com", "namecheap.com", "1and1.com", "hostgator.com",
    "bluehost.com", "dreamhost.com"
]
...
HTML_PARKING_INDICATORS = [
    ...
    'class="parked"', 'class="parking"', 'class="for-sale"',
    'class="placeholder"', 'class="coming-soon"',

    # IDs communes
    'id="parking"', 'id="parked"', 'id="for-sale"',
    'id="placeholder"', 'id="under-construction"',

    # Scripts de parking
    'parking.js', 'domain-parking.js', 'ads.js',
    'google_ad_client', 'googletag.cmd'
]
    ...
    for url in urls_a_tester:
        try:
            ...
            if reponse.status_code == 200:
                ...
                if verbose: print(f"  [+] Connexion réussie à : {url}")
                break
